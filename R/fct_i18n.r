...
translations <- list(
  ...
  en = list(
    ...
    "obj.browser.applied" = "Applied: %s",
    "obj.browser.please_enter_name" = "Please enter a name",
    "obj.browser.name_exists" = "Object name already exists",
    "obj.browser.copied_as" = "Copied as: %s",
    "obj.browser.rename_as" = "Renamed as: %s",
    "obj.browser.deleted" = "Deleted: %s",
    "obj.browser.refreshed" = "Refreshed",
    "obj.browser.copy_obj" = "Copy Object",
    "obj.browser.enter_new_name" = "Please enter the new object's name:",
    "obj.browser.new_name_placeholder" = "New object name...",
    "obj.browser.cancel" = "Cancel",
    "obj.browser.confirm" = "Confirm",
    "obj.browser.rename_obj" = "Rename Object",
    "obj.browser.source_not_found" = "Source object not found",
    "obj.browser.copy_failed" = "Copy failed",
    "obj.browser.rename_failed" = "Rename failed",
  ...
  zh = list(
    ...
    "obj.browser.applied" = "已应用: %s",
    "obj.browser.please_enter_name" = "请输入名称",
    "obj.browser.name_exists" = "对象名已存在",
    "obj.browser.copied_as" = "已复制为: %s",
    "obj.browser.rename_as" = "已重命名为: %s",
    "obj.browser.deleted" = "已删除: %s",
    "obj.browser.refreshed" = "已刷新",
    "obj.browser.copy_obj" = "复制对象",
    "obj.browser.enter_new_name" = "请输入新对象的名称：",
    "obj.browser.new_name_placeholder" = "新对象名称...",
    "obj.browser.cancel" = "取消",
    "obj.browser.confirm" = "确认",
    "obj.browser.rename_obj" = "重命名对象",
    "obj.browser.source_not_found" = "未找到源对象",
    "obj.browser.copy_failed" = "复制失败",
    "obj.browser.rename_failed" = "重命名失败",
